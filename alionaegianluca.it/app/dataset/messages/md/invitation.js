export default (isSingular) => ({
  full: {
    title: "După ceremonie v-om merge la Segnavento pentru a sărbători.",
    text: {
      part1: '',
      part2: 'Apoi va fi muzică și un open bar 😃'
    }
  },
  partial: {
    title: `Ne face plăcere să vă avem ca oaspeți pentru seara care va avea loc la ferma Al Segnavento.`,
