export default (isSingular) => ({
  ...
  partial: {
    title: `Ci farebbe piacere ${isSingular ? 'riceverti' : 'ricevervi'} successivamente per il taglio della torta che si terrà alle 21.30 presso l’agriturismo Al Segnavento.`,
